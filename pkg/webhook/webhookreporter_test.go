...
func Test_sendReports(t *testing.T) {
	testcases := []struct {
	...
	}{
		{
			...
			inputReport: v1beta1.VulnerabilityReport{
		...
		},
		{
			...
			want: `{"metadata":{},"report":{"updateTimestamp":null,"scanner":{"name":"","vendor":"","version":""},"registry":{"server":""},"artifact":{"repository":""},"summary":{"criticalCount":0,"highCount":0,"mediumCount":0,"lowCount":0},"secrets":[{"target":"foo bar baz","ruleID":"foo123","title":"bad bad secret","category":"","severity":"CRITICAL","match":""}]}}`,
