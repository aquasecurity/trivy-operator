...
require (
	...
	github.com/aquasecurity/trivy v0.52.1-0.20240626120649-0ccdbfbb6598
...
replace github.com/aquasecurity/trivy-checks => github.com/aquasecurity/trivy-checks v0.13.0
