...
var _ = Describe("ResourcesMetricsCollector", func() {
	...
	Context("VulnerabilityReport", func() {
		BeforeEach(func() {
			...
			vr3.Report.Summary.CriticalCount = 8
			vr3.Report.Vulnerabilities = []v1alpha1.Vulnerability{
				...
				{InstalledVersion: "1.19.7", Class: "os-pkgs", PackageType: "debian", PkgPath: "ab", Target: "ab2", Resource: "dppkg", Severity: v1alpha1.SeverityCritical, VulnerabilityID: "CVE-VR3-CRITICAL-1", Title: "VR3 Critical vulnerability 1", Score: ptr.To[float64](8.4)},
				{InstalledVersion: "1.19.7", Class: "os-pkgs", PackageType: "debian", PkgPath: "ab2", Target: "ab2", Resource: "dppkg", Severity: v1alpha1.SeverityCritical, VulnerabilityID: "CVE-VR3-CRITICAL-1", Title: "VR3 Critical vulnerability 1", Score: ptr.To[float64](8.4)},
				{InstalledVersion: "1.19.7", Class: "os-pkgs", PackageType: "debian", PkgPath: "", Target: "registry.example/images:tag-1.0.0", Resource: "dppkg", Severity: v1alpha1.SeverityCritical, VulnerabilityID: "CVE-VR3-CRITICAL-1", Title: "VR3 Critical vulnerability 1", Score: ptr.To[float64](8.4)},
				{InstalledVersion: "1.19.7", Class: "os-pkgs", PackageType: "debian", PkgPath: "some/path/to/file.war/WEB-INF/lib/example-lib-1.0.0.jar", Target: "Java", Resource: "dppkg", Severity: v1alpha1.SeverityCritical, VulnerabilityID: "CVE-VR3-CRITICAL-1", Title: "VR3 Critical vulnerability 1", Score: ptr.To[float64](8.4)},
				{InstalledVersion: "1.19.7", Class: "os-pkgs", PackageType: "debian", PkgPath: "ab2", Resource: "dppkg", Severity: v1alpha1.SeverityCritical, VulnerabilityID: "CVE-VR3-CRITICAL-1", Title: "VR3 Critical vulnerability 1", Score: ptr.To[float64](8.4)},
				{InstalledVersion: "1.19.7", Class: "os-pkgs", PackageType: "debian", Target: "ab2", Resource: "dppkg", Severity: v1alpha1.SeverityCritical, VulnerabilityID: "CVE-VR3-CRITICAL-1", Title: "VR3 Critical vulnerability 1", Score: ptr.To[float64](8.4)},
				{InstalledVersion: "1.19.7", Class: "os-pkgs", PackageType: "debian", Resource: "dppkg", Severity: v1alpha1.SeverityCritical, VulnerabilityID: "CVE-VR3-CRITICAL-1", Title: "VR3 Critical vulnerability 1", Score: ptr.To[float64](8.4)},
			}
		...
		trivy_vulnerability_id{class="os-pkgs",container_name="controller",fixed_version="",image_digest="sha256:5516d103a9c2ecc4f026efbd4b40662ce22dc1f824fb129ed121460aaa5c47f8",image_registry="k8s.gcr.io",image_repository="ingress-nginx/controller",image_tag="",installed_version="1.19.7",last_modified_date="",name="daemonset-ingress-nginx-controller-controller",namespace="ingress-nginx",package_type="debian",pkg_path="",published_date="",resource="dppkg",resource_kind="DaemonSet",resource_name="ingress-nginx-controller",severity="Critical",target="registry.example/images:tag-1.0.0",vuln_id="CVE-VR3-CRITICAL-1",vuln_score="8.4",vuln_title="VR3 Critical vulnerability 1"} 1
		trivy_vulnerability_id{class="os-pkgs",container_name="controller",fixed_version="",image_digest="sha256:5516d103a9c2ecc4f026efbd4b40662ce22dc1f824fb129ed121460aaa5c47f8",image_registry="k8s.gcr.io",image_repository="ingress-nginx/controller",image_tag="",installed_version="1.19.7",last_modified_date="",name="daemonset-ingress-nginx-controller-controller",namespace="ingress-nginx",package_type="debian",pkg_path="ab",published_date="",resource="dppkg",resource_kind="DaemonSet",resource_name="ingress-nginx-controller",severity="Critical",target="ab2",vuln_id="CVE-VR3-CRITICAL-1",vuln_score="8.4",vuln_title="VR3 Critical vulnerability 1"} 1
