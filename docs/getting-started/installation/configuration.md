...
| `report.resourceLabels`                        | N/A                                       | One-line comma-separated representation of the scanned resource labels which the user wants to include in the Prometheus metrics and report metadata. Example: `owner,app,tier`                                                                                                                                                                                                  |
| `report.resourceAnnotations`                   | N/A                                       | One-line comma-separated representation of the scanned resource annotations which the user wants to include in report metadata. Example: `owner,app,tier`                                                                                                                                                                                                                        |
| `report.additionalAnnotations`                 | `""`                                      | additionalAnnotations comma-separated representation of the annotations which the user wants the reports to be annotated with. Example: `foo=bar,env=stage` will annotate the reports with the annotations `foo: bar` and `env: stage`                                                                                                                                           |
| `metrics.resourceLabelsPrefix`                 | `k8s_label`                               | Prefix that will be prepended to the labels names indicated in `report.ResourceLabels` when including them in the Prometheus metrics. Note that only labels will be included in the Prometheus metrics, not annotations.                                                                                                                                                         |
