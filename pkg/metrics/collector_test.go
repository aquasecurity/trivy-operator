...
var _ = Describe("ResourcesMetricsCollector", func() {
	...
	Context("ConfigAuditReport", func() {
		BeforeEach(func() {
			...
			car2.Report.Checks = append(car1.Report.Checks, v1alpha1.Check{Success: true})
			...
			car3.Report.Checks = append(car1.Report.Checks, v1alpha1.Check{Success: true})
        ...
        trivy_resource_configaudits{name="configmap-test",namespace="some-ns",resource_kind="ConfigMap",resource_name="test",config_audit_id="car2 Id",config_audit_title="car2 config audit title", config_audit_description="car2 description for config audit", config_audit_category="car2 category for config audit",config_audit_success=true,severity="Critical"} 0
        trivy_resource_configaudits{name="configmap-test",namespace="some-ns",resource_kind="ConfigMap",resource_name="test",config_audit_id="car2 Id",config_audit_title="car2 config audit title", config_audit_description="car2 description for config audit", config_audit_category="car2 category for config audit",config_audit_success=true,severity="High"} 0
        trivy_resource_configaudits{name="configmap-test",namespace="some-ns",resource_kind="ConfigMap",resource_name="test",config_audit_id="car2 Id",config_audit_title="car2 config audit title", config_audit_description="car2 description for config audit", config_audit_category="car2 category for config audit",config_audit_success=true,severity="Low"} 1
        trivy_resource_configaudits{name="configmap-test",namespace="some-ns",resource_kind="ConfigMap",resource_name="test",config_audit_id="car2 Id",config_audit_title="car2 config audit title", config_audit_description="car2 description for config audit", config_audit_category="car2 category for config audit",config_audit_success=true,severity="Medium"} 0
