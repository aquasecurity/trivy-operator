...
| `nodeCollector.volumeMounts`| see values.yaml nodeCollector.volumeMounts key| node-collector pod volumeMounts definition for collecting config files information
| `nodeCollector.volumes`| see values.yaml nodeCollector.volumes key| node-collector pod volumes definition for collecting config files information                                                                       |
