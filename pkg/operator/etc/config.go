...
type Config struct {
	...
	ScanJobResultWaitTimeout                     time.Duration  `env:"OPERATOR_SCAN_JOB_RESULT_WAIT_TIMEOUT" envDefault:"30s"`
	ScanJobResultQueueFullTimeout                time.Duration  `env:"OPERATOR_SCAN_JOB_QUEUE_FULL_TIMEOUT" envDefault:"5s"`
