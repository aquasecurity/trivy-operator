...
![Version: 0.33.1](https://img.shields.io/badge/Version-0.33.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.31.1](https://img.shields.io/badge/AppVersion-0.31.1-informational?style=flat-square)
...
| trivyOperator.additionalReportAnnotations | string | `""` | additionalAnnotations comma-separated representation of the annotations which the user wants the reports to be annotated with. Example: `foo=bar,env=stage` will annotate the reports with the annotations `foo: bar` and `env: stage` |
...
| trivyOperator.reportResourceAnnotations | string | `""` | reportResourceAnnotations comma-separated representation of the scanned resource annotations which the user wants to include in report metadata. Example: `owner,app,tier` |
| trivyOperator.reportResourceLabels | string | `""` | reportResourceLabels comma-separated representation of the scanned resource labels which the user wants to include in the Prometheus metrics and report metadata. Example: `owner,app` |
