...
5. Create an annotated git tag and push it to the `upstream`. This will trigger the [`.github/workflows/release.yaml`] workflow
   ...
   ```sh
   git tag -v0.21.1 -m 'Release v0.21.1'
   git push upstream v0.21.1
   ```
