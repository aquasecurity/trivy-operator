...
func (in *ReportStatus) DeepCopyInto(out *ReportStatus) {
	*out = *in
	out.TotalCounts = in.TotalCounts
	in.UpdateTimestamp.DeepCopyInto(&out.UpdateTimestamp)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TotalCounts) DeepCopyInto(out *TotalCounts) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TotalCounts.
func (in *TotalCounts) DeepCopy() *TotalCounts {
	if in == nil {
		return nil
	}
	out := new(TotalCounts)
