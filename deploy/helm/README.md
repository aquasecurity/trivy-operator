...
| trivyOperator.exludeImages | string | `""` | exludeImages is a glob patterns for excluding images from scanning. Example: `acr.azurecr.io/*/*` will exclude images from azure container registry. |
