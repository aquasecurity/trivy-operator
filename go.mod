...
require (
	...
	github.com/aquasecurity/trivy-kubernetes v0.4.1-0.20230322101945-c2dd721e38f4
...
require (
	github.com/aquasecurity/go-dep-parser v0.0.0-20230302111817-e4068021315b // indirect
